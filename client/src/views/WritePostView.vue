<template>
  <div class="write-page">
    <div class="form-card">
      ...
      <!-- 标题 -->
      <el-input v-model="form.title" placeholder="请输入帖子标题" class="input-item" />
      ...
      <!-- 分类选择（下拉单选） -->
      <el-select v-model="form.categoryId" placeholder="选择分类" clearable class="input-item">
      ...
      >
        ...
        <template #tip>
          <div class="el-upload__tip">
            支持图片、PDF、Word、Excel、视频、压缩包，单文件最大100MB，最多5个
          </div>
        </template>
      </el-upload>

      <el-button type="primary" class="submit-btn" :loading="loading" @click="submitPost">
        提交发布
      </el-button>
    </div>
  </div>
